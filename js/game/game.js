...
var cardboardBoxFall = setInterval(function () {
    ...
    height[indexClasses] = height[indexClasses] + 10;
    console.log('height',height[indexClasses]);
    console.log('element',$boxIteration);

    $boxIteration.css({
        'transform': 'translateY(' + height[indexClasses] + 'px)'
    });
